          ...
          {activeTab === 'share' ? (
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                <div>
                  <Label className="text-xs sm:text-sm font-semibold mb-2 block">Width (px)</Label>
                  <Input
                    type="number"
                    value={embedWidth}
                ...
                <div>
                  <Label className="text-xs sm:text-sm font-semibold mb-2 block">Height (px)</Label>
                  <Input
                    type="number"
                    value={embedHeight}
                ...
                <div className="col-span-2 sm:col-span-1">
                  <Label className="text-xs sm:text-sm font-semibold mb-2 block">Auto-play</Label>
                  <div className="flex items-center h-10">
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <span className="ms-2 sm:ms-3 text-xs sm:text-sm font-medium text-gray-700">
                        {autoPlay ? 'On' : 'Off'}
                      </span>
                    </label>
                  </div>
              ...
              <div className="hidden md:block bg-gray-50 rounded-lg p-4 sm:p-6 border border-gray-200">
              ...
              <div className="bg-blue-50 rounded-lg p-3 sm:p-4 border border-blue-200">
                <h5 className="text-xs sm:text-sm font-semibold text-blue-900 mb-2 flex items-center">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <ul className="text-[10px] sm:text-xs text-blue-800 space-y-1">
                  ...
                  <li>• Demo will be interactive and responsive</li>
                  <li className="hidden sm:list-item">• Customize width, height, and auto-play as needed</li>
                </ul>
              </div>
            </motion.div>
          )}
